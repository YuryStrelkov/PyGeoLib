from ..common import NUMERICAL_FORMAT_4F as _4F, DATA_CLASS_INSTANCE_ARGS, NUMERICAL_ACCURACY
...
class Vector3:
    ...
    @staticmethod
    def lerp(pt1: 'Vector3', pt2: 'Vector3', t: float):
    ...
    @staticmethod
    def angle(a: 'Vector3', b: 'Vector3', c: 'Vector3') -> float:
        ba = b - a
        bc = b - c
        return math.acos(min(1.0, max(-1.0, Vector3.dot(ba, bc) / (ba.magnitude * bc.magnitude))))

    # @staticmethod
    # def cw(a: 'Vector3', b: 'Vector3', c: 'Vector3') -> bool:
    #     return Vector3.cross(b - a, b - c) > 0.0
